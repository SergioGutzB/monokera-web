...
async function PolicyDetails({ params }: { params: { number: string } }) {
  ...
  return (
    <div className="bg-white rounded-lg my-10 px-4 md:px-10 lg:px-20 mx-auto">
      ...
      <h1 className="text-4xl font-bold mb-10 mt-10 text-gray-600" aria-label={`Policy Details ${policyNumber}`}>
        Policy Details - {policyNumber.toUpperCase()}
      </h1>

      <div className="mb-4 grid md:grid-cols-2 grid-cols-1 justify-center">
        <section className={sectionClass}>
          <h2 className="text-xl font-semibold mb-2 text-purple-600">Policyholder</h2>
        ...
        <section className={sectionClass}>
          <h2 className="text-xl font-semibold mb-2 text-purple-600">Insureds</h2>
          <ul className="grid grid-cols-1 gap-4 list-none">
        ...
        <section className={sectionClass}>
          <h2 className="text-xl font-semibold mb-2 text-purple-600">Coverages</h2>
          <ul className="grid grid-cols-1 gap-4 list-none">
